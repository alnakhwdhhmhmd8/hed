...
Zed_Vip = (7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165)
Zed_Dev = (7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165 , 7728230165, 7728230165, 7728230165)
Zzz_Vip = (7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165, 7728230165)
zchannel = {"@Jakathon1", "@Jakathon2", "@Jakathon3", "@Jakathon4", "@Jakathon5", "@Jakathon6", "@Jakathon7", "@Jakathon8", "@Jakathon9", "@Jakathon10", "@Jakathon11", "@Jakathon12", "@Jakathon13", "@Jakathon14", "@Jakathon15", "@Jakathon16", "@Jakathon17", "@Jakathon18", "@Jakathon19", "@Jakathon20", "@Jakathon21", "@Jakathon22", "@Jakathon1", "@Jakathon1", "@Jakathon23", "@Jakathon24", "@Jakathon25"}
...
async def mybot(): #Code by T.me/zzzzl1l
    if gvarstatus("z_assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"• بـوت جـاكثون المسـاعـد ♥️🦾 الخـاص بـ  {Zname} .\n• يحتوي على عدة أقسام خدمية\n• زخرفة - تواصل - حذف حسابات")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://files.catbox.moe/r40wgp.mp4",
                caption=f"**⌔ مرحبـاً عـزيـزي** {zel_zal} 🫂\n**⌔ تـم تشغـيل سـورس جـاكثون 🧸♥️**\n**⌔ التنصيب الخاص بـك .. بنجـاح ✅**\n**⌔ لـ تصفح قائمـة الاوامـر 🕹**\n**⌔ ارسـل الامـر** `{cmdhr}مساعده`",
                buttons=[[Button.url("𝐉𝐀𝐊𝐀𝐓𝐇𝐎𝐍 🎡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁", "https://t.me/xvwwvl")],[Button.url("الشروحات ²", "https://t.me/Jakathon3"), Button.url("الشروحات ¹", "https://t.me/Jakathon2")],[Button.url("حلـول الأخطـاء", "https://t.me/Jakathon1")],[Button.url("التحـديثـات", "https://t.me/xvwwvl")],[Button.url("مطـور السـورس", "https://t.me/wwvvwl")]]
            )
    except Exception as e:
        LOGS.error(e)
        return None
