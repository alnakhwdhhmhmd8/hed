...
zed_dev = (7728230165, 7728230165, 7728230165)
zel_dev = (7728230165, 7728230165, 7728230165, 7728230165)
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐉𝐀𝐊𝐀𝐓𝐇𝐎𝐍 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/xvwwvl) 𓆪\n\n"
