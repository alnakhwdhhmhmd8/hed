...
ZelzalVP_cmd = (
    "𓆩 𝐉𝐀𝐊𝐀𝐓𝐇𝐎𝐍 𝗩𝗮𝗿𝘀 **🝢 اوامـر الفـارات** 𓆪\n"
    "**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @xvwwvl\n\n"
...
async def variable(event):
    ...
    zed = await edit_or_reply(event, "**⎉╎جـاري أعـداد المنطقـه الزمنيـه لـ جـاكثون 🌐...**")
    # All Rights Reserved for "Zed-Thon" "زلـزال الهيبـه"
