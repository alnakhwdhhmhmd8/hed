#𝗭𝗧𝗵𝗼𝗻 - كتابـة وتعديـل سـورس جـاكثون
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 7728230165 or idd == 7728230165 or idd == 7728230165 or idd == 7728230165:
            ...
            animation_chars = [
                "**⌔: جـارِ الاتصال بـ خـوادم جـاكثون المتخصصه بالـتهكيـر**",
