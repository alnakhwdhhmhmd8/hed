...
ZelzalDV_cmd = (
    "[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊𝐀𝐓𝐇𝐎𝐍 - اوامــر المطـور المســاعد](t.me/xvwwvl) .\n\n"
    ...
    "\n𓆩 [𝐉𝐀𝐊𝐀𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/xvwwvl) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**⎉╎يتم الان اعـادة تشغيـل بـوت جـاكثون انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝐉𝐀𝐊𝐀𝐓𝐇𝐎𝐍 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**⎉╎يتم الان اعـادة تشغيـل بـوت جـاكثون انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
