                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل جـاكثون 𝐉𝐀𝐂𝐊𝐀𝐓𝐇𝐎𝐍--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع جـاكثون 𝐉𝐀𝐂𝐊𝐀𝐓𝐇𝐎𝐍--------"
                        ...
                        link = "[𐇮 𝐉𝐀𝐊 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/wwvvwl)"
                        text = (
                            "**✘ تقـريـر اشعـار جـاكثون 𝐉𝐀𝐂𝐊𝐀𝐓𝐇𝐎𝐍 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار جـاكثون 𝐉𝐀𝐂𝐊𝐀𝐓𝐇𝐎𝐍 ✘**\n\n "
                        link = "[𐇮 𝐉𝐀𝐊  𐇮](https://t.me/wwvvwl)"
